...
(function (DragDropTouch_1) {
  ...
  var DragDropTouch = (function () {
    ...
    DragDropTouch.prototype._shouldHandlePressHoldMove = function (
      e,
    ) {
      return (
    ...
    DragDropTouch.prototype._shouldCancelPressHoldMove = function (
      e,
    ) {
      return (
        DragDropTouch._ISPRESSHOLDMODE &&
    ...
    DragDropTouch.prototype._getDelta = function (e) {
      ...
      return (
        Math.abs(p.x - this._ptDown.x) +
        Math.abs(p.y - this._ptDown.y)
      );
    };
